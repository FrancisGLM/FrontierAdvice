...
export interface ApiEstadoDiarioEstadoDiario
  ...
  info: {
    displayName: 'EstadoDiario';
    pluralName: 'estado-diarios';
...
export interface ApiPasoFronterizoPasoFronterizo
  extends Struct.CollectionTypeSchema {
  collectionName: 'paso_fronterizos';
  info: {
    displayName: 'PasoFronterizo';
    pluralName: 'paso-fronterizos';
